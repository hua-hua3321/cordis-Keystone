...
> **本文性质**：差距登记 + 解决方案集。**P57-P63 已全部收敛**：11 项实施（14 log §7.57-§7.62）、CA-8 弃用（ADR-0016）、CA-11 保留扩展点、CA-13 场景驱动延后、CA-14/16/17/18 接受差异（12 §11.1 + 11 §4.1 注记）。各条目标题/行内已标实施落点。
...
| CA-8 | JSON 格式 | — | S | ✅ 已决策弃用（ADR-0016，P63 人工裁定） |
| CA-11 | `cordis:` 内建前缀 | — | S | ⏸ 保留为扩展点（P63 人工裁定；内建 = 组合根直接构造） |
| CA-14/16/17/18 | 四项语义差异 | — | — | ✅ 接受差异已落注（12 §11.1 + 11 §4.1 观察项，P63） |
