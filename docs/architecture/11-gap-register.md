...
| 批 | 项 | 状态 | 落点 |
|----|----|------|------|
| P0 | CAV-P0-1..7（组归属丢失/新组必败/结构半应用/插值回退/写竞态/订阅泄漏/计时器收口） | ❌ 待修 | 19 §1 |
| P1 | CAV-P1-1..7（AwaitAsync 死字段/停止竞态/重入守卫/门控两竞态/disabled 级联/组转换分级） | ❌ 待修 | 19 §2 |
| D | CAV-D-1..9（真热更新/字段合并/parent 缺省/运行时复原/Removed 回滚/Provide-set/门控时机/scope 语义/Effect 句柄） | ⚠️ 待决策 | 19 §3 |
| P2 | CAV-P2-1..23 | ⚠️ 按价值排序 | 19 §4 |
