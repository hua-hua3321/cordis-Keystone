...
**CAV 系列（§3.4，19 号第二轮复核）为当前开放批次**——P0 七项待修。CA 系列（§3.3，18 项）已全部收敛（P57-P63）：11 项已实施、CA-8 弃用（ADR-0016）、CA-11 保留扩展点、CA-13 场景驱动延后、CA-14/16/17/18 接受差异——但其中 CA-3/CA-9 的实施经第二轮复核发现未测路径缺陷（P0-1/2/3/7，见 19 §1）。历史残留跟踪点：
...
| 批 | 项 | 状态 | 落点 |
|----|----|------|------|
| P0 | CAV-P0-1..7 | 🔶 P0-1/2/3/6/7 已修（P64，W64-01）；P0-4/5 待 P65 | 19 §1 |
| P1 | CAV-P1-1..7（AwaitAsync 死字段/停止竞态/重入守卫/门控两竞态/disabled 级联/组转换分级） | ❌ 待修（P65/P66） | 19 §2 |
| D | CAV-D-1..9 | ✅ 已裁定（全部按 Cordis，19 §8）；D-4/5/9 已实施（P64）——余 D-1/2/3/6/7/8 排队 P67-P69 | 19 §8 |
| P2 | CAV-P2-1..31（含 EntryGroup 删除/PENDING 语义/EntryPatcher 对齐等裁定联动项） | ⚠️ 随批次消化 | 19 §4/§9 |
