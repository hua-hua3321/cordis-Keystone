...
| [decisions/](decisions/README.md) | 决策记录（ADR-0001 ~ 0017，设计期已收敛；实现期新决策走 14 §4 通道 + ADR-0017） | accepted |
